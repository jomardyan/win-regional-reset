 ...
 *
 * Cross-platform comprehensive regional settings management tool.
 * Features: Interactive menu, config management, logging, backup/restore.
...
public:
    RegionalSettingsManager() : logger("", true) {
        loadConfig();
    ...
    bool applyLocale(const string& locale, bool force = false) {
        ...
        // Set comprehensive registry values
